...
public class Sort {
    ...
    public static void test_radix() {
    	System.out.println("Radix Sort test");
    	int a[] = {143, 322, 246, 755, 123, 563, 514, 522};
    	radix_sort(a,a.length,2);
    	display(a,a.length);
    	System.out.println();
    }

    public static void test_sort(int a[], String option) {
    	switch (option) {
      case "--s":
	...
	System.out.println("[--sort]:--s Selection Sort");

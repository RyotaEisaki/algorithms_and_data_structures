...
public class BinarySearchTree {
    static IntNode root;        // 2分探索木の根(nullで初期化)
	...
	IntNode p = root;        // 根に着目
	IntNode parent = null;   // 現在着目している節の親を指す
	...
	while (p != null) {
		...
		if (p.left == null || p.right == null) { // 1つ以下の子を持つ
		    ...
		    IntNode r = p.right;    // p の右部分木の最小値を探す
		    parent = p;
		    lr = Lr.R;              // 右の子である
    ...
    public static void deleteBstEl(IntNode p, IntNode parent, Lr lr) {

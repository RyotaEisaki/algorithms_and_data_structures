public class Double_Shift {
    DictData[] H;              // 辞書の配列
    int B;                     // 配列の大きさ

  Double_Shift(int len) {
	B = len;
	H = new DictData[B];
	for (int i = 0; i < B; i++) {
	    H[i] = new DictData();
